# Шифр Цезаря
SYMBOLS = 'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя1234567890!@#$%^&*()'
MAX_KEY_SIZE = len(SYMBOLS)

def getMode():
    while True:
        print('Вы хотите зашифровать текст?')
        mode = input().lower()
...
def getTranslatedMessage(mode, message, key):
    ...
    for symbol in message:
        ...
        if symbolIndex == -1: #Символ не найден в SYMBOLS.
            # Добавить этот символ без изменений.
            translated += symbol
        else:
